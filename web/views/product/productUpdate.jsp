...
%>
    ...
    $(document).ready(function(){
    	$("addProduct").click(function(){
    		...
    		if(pName==""){
    			alert("상품명을 입력해주세요");
    			pName.focus().pName.text(".");
    		}else if(pPrice==""){
    			alert("상품가격을 입력해주세요");
    			pPrice.focus().pPrice.text("상품가격을 입력해주세요");
    		}else if(pDiscount){
    			alert("할인률을 입력해주세요");
    			pDiscount.focus().pDiscount.text(".");
    		}else if(pStock){
    			alert("상품갯수을 입력해주세요");
    			pStock.focus();
    			pStock.text(".");
    		...
    		//상풍정보전송
     		document.form.action="<%=request.getContextPath()%>/product/productUpdate";
...
<section class="product-resiter">
    <h1>상품등록</h1>
    <form id="form" name="form" action="<%=request.getContextPath() %>/product/productUpdateEnd" method="post" class="product-resiter-container" enctype="multipart/form-data">
       <ol>
    ...
    <li class="file--container">
       ...
       <div class="product-btn-box">
           <button type="submit" class="product-register" id="addProduct" onclick="location.replace<%=request.getContextPath()%>/product/productUpdateEnd">등록</button>
